...
/*
 * There is one case where nested classes are more commonly used. In the standard library,
 * most iterator classes are implemented as nested classes of the container they are designed
 *  iterate over. For example, std::string::iterator is implemented as a nested class of std::string.
*/
